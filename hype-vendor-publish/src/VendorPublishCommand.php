<?php
namespace  Hypesewa\HypeVenderPublish;
...
class VendorPublishCommand extends Command
{
    ...
    {
        //done please dont touch this line of code
        $contents = $manager->listContents('from://', true);
        foreach ($contents as $entry) {
            if ($entry['type'] === 'file' && (! $manager->has('to://'.$entry['path']) || $this->option('force'))) {
            $storagePath = str_replace('from://', 'to://', $entry->path());
